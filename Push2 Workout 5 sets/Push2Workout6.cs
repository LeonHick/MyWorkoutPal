...
namespace MyWorkoutPal
{
    ...
    public class Push2Workout6 : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            var exercise1 = listSource[5].Name;
            var sets = listSource[5].Sets;
            var reps = listSource[5].Reps;
            var weight = listSource[5].Weight;
            ...
            done.Click += async delegate
            {
                ...
                try
                {
                    test = listSource[6].Name;
                    var intent = new Intent(this, typeof(PushEditor2));
