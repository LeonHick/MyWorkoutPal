...
{
    [Activity(Label = "PushWorkout5")]
    public class PushWorkout5 : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                var sets = listSource[4].Sets;
                var reps = listSource[4].Reps;
                var weight = listSource[4].Weight;
                var exercise1 = listSource[4].Name;
                var id = listSource[4].Id;
                ...
                done.Click += async delegate
                {
                    ...
                    try
                    {
                        ...
                        test = listSource[5].Name;

                        var bundle = new Bundle();
                        bundle.PutString("workout", workout);
                        var intent = new Intent(this, typeof(PushWorkout6));
