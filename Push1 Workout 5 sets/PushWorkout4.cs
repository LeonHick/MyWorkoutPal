...
{
    [Activity(Label = "PushWorkout4")]
    public class PushWorkout4 : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                var sets = listSource[3].Sets;
                var reps = listSource[3].Reps;
                var weight = listSource[3].Weight;
                var exercise1 = listSource[3].Name;
                var id = listSource[3].Id;
                ...
                done.Click += async delegate
                {
                    ...
                    try
                    {
                        ...
                        test = listSource[4].Name;

                        var bundle = new Bundle();
                        bundle.PutString("workout", workout);
                        var intent = new Intent(this, typeof(PushWorkout5));
